...
public class HelloWorld {
    ...
    public String sayHelloWorldWithContext(String name, Context context) {
        ...
        context.getLogger()
               .log("Lambda Function Name:" + context.getFunctionName() + "Version:" + context.getFunctionVersion()
                    + "Arn:" + context.getInvokedFunctionArn() + "Allocated Memory:" + context.getMemoryLimitInMB()
